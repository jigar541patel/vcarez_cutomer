...
class _MedicineListScreenState extends State<MedicineListScreen> {
  ...
  MedicineListBloc medicineListBloc = MedicineListBloc();
  String strTitle = "";
  PopularMedicineModel medicineListModel = PopularMedicineModel();
        ...
        body: SafeArea(
          ...
          SingleChildScrollView(
            child: BlocProvider(
              ...
              child: BlocConsumer<MedicineListBloc, MedicineListState>(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Align(
                                  ...
                                  child: BlocConsumer<MedicineListBloc,
                                      MedicineListState>(
                                    listener: (context, state) {
                                      // TODO: implement listener
                                      if (state is OnMedicineListLoaded) {
